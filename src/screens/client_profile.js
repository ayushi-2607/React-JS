...
import Nav from './nav';
import '../screens/client_profile.css';
			...
			<div class="page-wrapper bg-light">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 id="pageTitle" class="page-title">Profile</h3>
								<ul class="breadcrumb">
									<li><Link class="breadcrumb-item text-decoration-none" to="/employee"><b>Dashboard</b></Link></li>
					...
					<div class="card mb-0 bg-white shadow-sm">
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														<h3 class="user-name m-t-1">Global Technologies</h3>
														<h5 class="company-role m-t-1 mb-0">Barry Cuda</h5>
											...
											<div class="card bg-white">
												<div class="card-body">
													...
													<div class="progress progress-xs mb-0">
														<div class="progress-bar bg-success" role="progressbar" data-toggle="tooltip" title="40%"></div>
													</div>
												</div>
											</div>
										</div>
														...
														<div class="task-list-body">
															<ul id="task-list">
																<li class="task">
																	<div class="task-container">
																		<span class="task-action-btn task-check">
																			<span class="action-circle small complete-btn" title="Mark Complete">
																			<i id="checkIcon" class="fa fa-check-circle fa-2x mr-2 mt-0"  aria-hidden="true"></i>
																			</span>
																		</span>
																		<span class="task-label" contenteditable="true">Patient appointment booking</span>
																		<span class="task-action-btn task-btn-right">
																			<span class="action-circle large" title="Assign">
																			<i id="addUser" class="fa fa-user-plus" aria-hidden="true"></i>
																			</span>
																			<span class="action-circle large delete-btn" title="Delete Task">
																			<i id="deleteUser" class="fa fa-trash" aria-hidden="true"></i>
																			</span>
																		</span>
																	</div>
																</li>
																...
																{/* <li class="completed task">
																	<div class="task-container">
																		<span class="task-action-btn task-check">
																			<span class="action-circle complete-btn" title="Mark Complete">
																			<i id="checkIcon" class="fa fa-check-circle fa-2x mr-2 mt-0"  aria-hidden="true"></i>
																			</span>
																		</span>
